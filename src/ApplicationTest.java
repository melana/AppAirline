...
//	    System.out.print (new FilterFuelConsumption().FilterFuelConsumption(airline, 100,7000));
//		System.out.print (new FilterFuelConsumption().FilterFuelConsumption(airline, -100,20000));
